import type { KeycloakConfig, KeycloakError, KeycloakInitOptions, KeycloakLoginOptions, KeycloakProfile, KeycloakPromise, KeycloakResourceAccess, KeycloakRoles, KeycloakTokenParsed } from 'keycloak-js';
import Keycloak from 'keycloak-js';
export { KeycloakConfig, KeycloakError, KeycloakInitOptions, Keycloak, KeycloakLoginOptions, KeycloakProfile, KeycloakPromise, KeycloakResourceAccess, KeycloakRoles, KeycloakTokenParsed, };
...
export interface VueKeycloakInstance {
    ...
    loginFn?(options?: KeycloakLoginOptions): KeycloakPromise<void, void>;
